...
export class BooksController {
  ...
  @ApiResponse({ status: 200, type: BooksListResponseDto, description: 'Published books returned successfully' })
  ...
  @ApiOperation({ summary: 'Admin/Creator: List all catalog books including drafts' })
  @ApiResponse({ status: 200, type: BooksListResponseDto, description: 'Admin/creator books returned successfully' })
  ...
  @ApiResponse({ status: 200, type: BookResponseDto, description: 'Book returned successfully' })
  ...
  @ApiResponse({ status: 201, type: BookResponseDto, description: 'Book created successfully' })
  ...
  @ApiResponse({ status: 200, type: BookResponseDto, description: 'Book updated successfully' })
